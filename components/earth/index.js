...
export function Earth(props) {
  ...
  // const colorMap = new THREE.TextureLoader().load(EarthDayMap);
  // const normalMap = new THREE.TextureLoader().load(EarthNormalMap);
  // const specularMap = new THREE.TextureLoader().load(EarthSpecularMap);
  // const cloudsMap = new THREE.TextureLoader().load(EarthCloudsMap);
